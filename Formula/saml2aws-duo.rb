...
class Saml2awsDuo < Formula
  ...
  version '2.28.0-duo'
  if OS.mac?
    url 'https://github.com/ahrenstein/homebrew-taps/releases/download/v1.0.1/saml2aws_2.28.0-duo_darwin_amd64.tar.gz'
    sha256 '42c16edadc1e17ced46627f6944826250ec70bfce7675515f9fe58f611ac2bd8'
  elsif OS.linux?
    url 'https://github.com/ahrenstein/homebrew-taps/releases/download/v1.0.1/saml2aws_2.28.0-duo_linux_amd64.tar.gz'
